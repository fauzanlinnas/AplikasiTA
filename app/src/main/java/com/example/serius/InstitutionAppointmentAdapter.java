...
public class InstitutionAppointmentAdapter extends ArrayAdapter<Appointment> {
    ...
    public InstitutionAppointmentAdapter(Context context, ArrayList<Appointment> appointments) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.institution_appointment_list, parent, false);
        }
        ...
        donorRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                appointmentDonor[0] = finalConvertView1.findViewById(R.id.tvAppointmentDonorInstitution);
        ...
        requesterRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                appointmentRequester[0] = finalConvertView.findViewById(R.id.tvAppointmentRequesterInstitution);
        ...
        appointmentDate = convertView.findViewById(R.id.tvAppointmentDateInstitution);
        appointmentTime = convertView.findViewById(R.id.tvAppointmentTimeInstitution);
